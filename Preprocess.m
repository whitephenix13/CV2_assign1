function [ PC ] = Preprocess( N, method )


%Load image and mask
if N<10
    img = uint16(imread(strcat('C:/Users/Vladimir/Desktop/CV/data/000000000',num2str(N), '.jpg')));
    mask = uint16(imread(strcat('C:/Users/Vladimir/Desktop/CV/data/000000000',num2str(N),'_mask.jpg')));
    depth = imread(strcat('C:/Users/Vladimir/Desktop/CV/data/000000000',num2str(N),'_depth.png'));
else
    img = uint16(imread(strcat('C:/Users/Vladimir/Desktop/CV/data/00000000',num2str(N),'.jpg')));
    mask = uint16(imread(strcat('C:/Users/Vladimir/Desktop/CV/data/00000000',num2str(N),'_mask.jpg')));
    depth = imread(strcat('C:/Users/Vladimir/Desktop/CV/data/00000000',num2str(N),'_depth.png'));
end
